                        ...
                        if let orderDetail = ordersHireHistoryOrder.orderDetails.first
                        {
                            if ordersHireHistoryOrder.paymentStatus == "Chưa thanh toán" {
                                NavigationLink {
                                    ...
                                    HireOrderRowView(viewModel: viewModel, id: ordersHireHistoryOrder.id, totalPrice: ordersHireHistoryOrder.finalPrice, paymentStatus: ordersHireHistoryOrder.paymentStatus, deliveriteFree: ordersHireHistoryOrder.deliveryFee, deposit: orderDetail.deposit, numberOfMonth: orderDetail.numberMonth, orderDetail: orderDetail, isCancellable: viewModel.selectedOrderState == .waitingForConfirm || viewModel.selectedOrderState == .waitingForPackage, isReceived: viewModel.selectedOrderState == .waitingForDeliver)
                                        .foregroundStyle(.black)
                                }
                            } else if ordersHireHistoryOrder.status == 4 {
                                DeliveredHireOrderRowView(viewModel: viewModel, id: ordersHireHistoryOrder.id, totalPrice: ordersHireHistoryOrder.finalPrice, paymentStatus: ordersHireHistoryOrder.paymentStatus, deliveriteFree: ordersHireHistoryOrder.deliveryFee, deposit: orderDetail.deposit, numberOfMonth: orderDetail.numberMonth, orderDetail: orderDetail, isCancellable: viewModel.selectedOrderState == .waitingForConfirm || viewModel.selectedOrderState == .waitingForPackage, isReceived: viewModel.selectedOrderState == .waitingForDeliver)
                            } else {
                                HireOrderRowView(viewModel: viewModel, id: ordersHireHistoryOrder.id, totalPrice: ordersHireHistoryOrder.finalPrice, paymentStatus: ordersHireHistoryOrder.paymentStatus, deliveriteFree: ordersHireHistoryOrder.deliveryFee, deposit: orderDetail.deposit, numberOfMonth: orderDetail.numberMonth, orderDetail: orderDetail, isCancellable: viewModel.selectedOrderState == .waitingForConfirm || viewModel.selectedOrderState == .waitingForPackage, isReceived: viewModel.selectedOrderState == .waitingForDeliver)
                            }
                        }
