...
// MARK: - PREVIEW
#Preview {
    OwnerItemDetailScreen(plant: Plant(id: 1, name: "Name", title: "Title", finalPrice: 1000, description: "", mainImage: "", imagePlants: [ImagePlantResponse(id: 1, imageUrl: "")], status: 1, isActive: false, typeEcommerceId: 1, code: "43"))
}
